...
/* Set APIs */
extern ADI_WDT_RESULT_TYPE      adi_WDT_SetEnable            (ADI_WDT_DEV_HANDLE const hDevice, const bool bEnable);
extern ADI_WDT_RESULT_TYPE      adi_WDT_SetIRQMode           (ADI_WDT_DEV_HANDLE const hDevice, const bool bIRQMode);
extern ADI_WDT_RESULT_TYPE      adi_WDT_SetLoadCount         (ADI_WDT_DEV_HANDLE const hDevice, const uint16_t LoadCount);
extern ADI_WDT_RESULT_TYPE      adi_WDT_SetPDClear           (ADI_WDT_DEV_HANDLE const hDevice, const bool bPDClear);
extern ADI_WDT_RESULT_TYPE      adi_WDT_SetPrescale          (ADI_WDT_DEV_HANDLE const hDevice, const ADI_WDT_PRESCALE_TYPE Prescale);
extern ADI_WDT_RESULT_TYPE      adi_WDT_SetWaitMode          (ADI_WDT_DEV_HANDLE const hDevice, const bool bWaitMode);

/* Get APIs */
extern uint16_t                 adi_WDT_GetCount             (ADI_WDT_DEV_HANDLE const hDevice);
extern bool                   adi_WDT_GetEnable            (ADI_WDT_DEV_HANDLE const hDevice);
extern bool                   adi_WDT_GetIRQMode           (ADI_WDT_DEV_HANDLE const hDevice);
extern bool                   adi_WDT_GetPDClear           (ADI_WDT_DEV_HANDLE const hDevice);
extern ADI_WDT_PRESCALE_TYPE    adi_WDT_GetPrescale          (ADI_WDT_DEV_HANDLE const hDevice);
extern bool                   adi_WDT_GetWaitMode          (ADI_WDT_DEV_HANDLE const hDevice);

/* Status APIs */
extern bool                   adi_WDT_GetCLRISyncStatus    (ADI_WDT_DEV_HANDLE const hDevice);
extern bool                   adi_WDT_GetCONSyncStatus     (ADI_WDT_DEV_HANDLE const hDevice);
extern bool                   adi_WDT_GetIRQPendStatus     (ADI_WDT_DEV_HANDLE const hDevice);
extern bool                   adi_WDT_GetLDSyncStatus      (ADI_WDT_DEV_HANDLE const hDevice);
extern bool                   adi_WDT_GetLockedStatus      (ADI_WDT_DEV_HANDLE const hDevice);
