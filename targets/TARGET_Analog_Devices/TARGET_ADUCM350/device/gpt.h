...
/* Timer Status */
extern bool adi_GPT_GetTimerBusy                             (ADI_GPT_HANDLE);
extern bool adi_GPT_GetCaptureEventPending                   (ADI_GPT_HANDLE);
extern bool adi_GPT_GetTimeOutEventStatus                    (ADI_GPT_HANDLE);
extern bool adi_GPT_GetTimerConfigValid                      (ADI_GPT_HANDLE);
...
extern ADI_GPT_RESULT_TYPE adi_GPT_SetCaptureEventEnable       (ADI_GPT_HANDLE, bool bEnable);
extern ADI_GPT_RESULT_TYPE adi_GPT_SetPrescaler                (ADI_GPT_HANDLE, ADI_GPT_PRESCALER_TYPE);
extern ADI_GPT_RESULT_TYPE adi_GPT_SetTimerEnable              (ADI_GPT_HANDLE, bool bEnable);
extern ADI_GPT_RESULT_TYPE adi_GPT_SetPeriodicMode             (ADI_GPT_HANDLE , bool bMod, uint16_t reloadValue);
