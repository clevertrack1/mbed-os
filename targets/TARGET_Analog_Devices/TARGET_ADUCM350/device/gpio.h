...
#define ADI_GPIO_PORT_0 (ADI_GPIO0_BASE)      /*!< Port 0 */
#define ADI_GPIO_PORT_1 (ADI_GPIO1_BASE)      /*!< Port 1 */
#define ADI_GPIO_PORT_2 (ADI_GPIO2_BASE)      /*!< Port 2 */

#define ADI_GPIO_PORT_3 (ADI_GPIO3_BASE)      /*!< Port 3 */
#define ADI_GPIO_PORT_4 (ADI_GPIO4_BASE)      /*!< Port 4 */
...
extern ADI_GPIO_RESULT_TYPE  adi_GPIO_SetOutputEnable          (const ADI_GPIO_PORT_TYPE Port, const ADI_GPIO_DATA_TYPE Pins, const bool bFlag);  /*!< Enables/disables the output driver for GPIO output pins */

/* ADuCM350 has seperate input and output enables that are independent of each other */
extern ADI_GPIO_RESULT_TYPE  adi_GPIO_SetInputEnable           (const ADI_GPIO_PORT_TYPE Port, const ADI_GPIO_DATA_TYPE Pins, const bool bFlag);  /*!< Enables/disables the output driver for GPIO output pins */

extern ADI_GPIO_RESULT_TYPE  adi_GPIO_SetPullUpEnable          (const ADI_GPIO_PORT_TYPE Port, const ADI_GPIO_DATA_TYPE Pins, const bool bFlag);  /*!< Enables/disables the pullup for GPIO output pins */
