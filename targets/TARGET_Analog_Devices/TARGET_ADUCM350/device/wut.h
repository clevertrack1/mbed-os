...
extern ADI_WUT_RESULT_TYPE       adi_WUT_SetFreezeEnable    (ADI_WUT_DEV_HANDLE const hDevice, const bool bEnable);
extern ADI_WUT_RESULT_TYPE       adi_WUT_SetInterruptEnable (ADI_WUT_DEV_HANDLE const hDevice, const ADI_WUT_TARGET_TYPE target, const bool bEnable);
...
extern ADI_WUT_RESULT_TYPE       adi_WUT_SetTimerEnable     (ADI_WUT_DEV_HANDLE const hDevice, const bool bEnable);
extern ADI_WUT_RESULT_TYPE       adi_WUT_SetTimerMode       (ADI_WUT_DEV_HANDLE const hDevice, const ADI_WUT_MODE_TYPE Mode);
extern ADI_WUT_RESULT_TYPE       adi_WUT_SetWakeUpEnable    (ADI_WUT_DEV_HANDLE const hDevice, const bool bEnable);
...
extern bool                    adi_WUT_GetFreezeEnable    (ADI_WUT_DEV_HANDLE const hDevice);
extern bool                    adi_WUT_GetInterruptEnable (ADI_WUT_DEV_HANDLE const hDevice, const ADI_WUT_TARGET_TYPE target);
...
extern bool                    adi_WUT_GetTimerEnable     (ADI_WUT_DEV_HANDLE const hDevice);
extern ADI_WUT_MODE_TYPE         adi_WUT_GetTimerMode       (ADI_WUT_DEV_HANDLE const hDevice);
extern bool                    adi_WUT_GetWakeUpEnable    (ADI_WUT_DEV_HANDLE const hDevice);
